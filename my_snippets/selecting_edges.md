...
vector<int> g[N];
int ed[N][2];
bool used[N]; // to check whether dfs on some node is done
bool usedEd[N]; // to note whether some node is used
vector<pii> ans;

// get other end of the edge[id]
